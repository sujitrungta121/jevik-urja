		...
		<div class="row">
			<div class="col-12">
				<div aria-label="breadcrumb">
				  <ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="<?php echo base_url();?>frontend/index.html">Home</a></li>
					<li class="breadcrumb-item"><a href="<?php echo base_url();?>frontend/product-list.html"><?php echo $details["category_name"];?></a></li>
								...
								<div class="pro-content">
										...
										<div class="col-xl-6">
											<form>
												<select name="variant_id" class="form-control">
													<?php foreach($details["options"] as $opt){?>
									...
									<div class="row mt-3">
										<div class="col-xl-6 col-sm-7">
											<h3><span>MRP:</span> <span>₹<?php echo $details["old_price"];?></span> <span>₹<?php echo $details["price"];?></span></h3>
										</div>
	...
	<section class="similar-product">
		<div class="container">
			<div class="row">
				<div class="col-xl-12">
					<h2 class="title">Similar Products <a href="<?php echo base_url();?>frontend/#" class="float-right v-btn btn"><i class="fas fa-eye mr-2"></i> View All</a></h2>
				</div>
				<div class="col-xl-12">
