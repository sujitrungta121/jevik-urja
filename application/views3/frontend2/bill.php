	...
	<div class="wrap" id="printArea">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr style="border:1px solid #bfbfbf; display:block;">
		    <td width="20%"><h1 style="padding: 15px 40px;color: #fff;background: #1fb5ad;font-size: 30px;text-transform: uppercase;margin: 0;
		    float: left;">Bill : <?php echo $order_details["order_id"];?></h1></td>
		    <td width="50%">&nbsp;</td>
		    <td width="30%">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr valign="top">
		    <td width="30%">
		        ...
		        <p style="margin:0;"><?php echo $order_details["city"];?><br>
		        <p style="margin:0;"><?php echo $order_details["pin_code"];?><br>	
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
		    <td width="68%">
		    	<p>Payment Method</p>
		        <p><?php echo $order_details["payment_mode_name"];?></p>
		        <h3 style="color:#1fb5ad;"><i>Thank you for your business</i></h3>
		    </td>
