				...
				<div class="row">
					<div class="col-xl-12">
						<div class="t-content">
							...
							<p>Download the App <a href="https://play.google.com/store/apps/details?id=com.mk.gomart&hl=en" target="blank"><img src="<?php echo base_url();?>frontend/assets/images/playstore.png" class="img-fluid" alt="playstore"></a></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row justify-content-between">
					...
					<div class="col-xl-5 col-md-5">
						...
						<div class="ajs-instantsearch" ng-if="search_val!='' " style="display:none;" id="searchResultArea">
							<div class="ajs-inner" >
...
<?php
$fMsgType=$this->session->flashdata("action_message_type2");
if($fMsgType=="success"){?>
<div class="container" style="margin-top:20px;">
	<div class="alert alert-success">
	  <?php echo $this->session->flashdata("action_message2");?>
	</div>
</div>
<?php }elseif($fMsgType=="danger"){?>
<div class="container"  style="margin-top:20px;">
