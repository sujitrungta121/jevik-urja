...
<div id="page-wrapper" ng-app="myApp" ng-controller="Ctrl">
            ...
            <div class="container-fluid">
                        <h1 class="page-header">
                            <?php echo $product_details->name;?> <small>// Variant List</small>
                            <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Add New Variant</button>
                        </h1>
...
<div id="myModal" class="modal fade" role="dialog">
  ...
  <div class="form-group">
    <label class="control-label col-sm-3" for="email">Variant :</label>
    <div class="col-sm-9">
  ...
  <div class="form-group">
    <label class="control-label col-sm-3" for="email">Main Price :</label>
    <div class="col-sm-9">
  ...
  <div class="form-group">
    <label class="control-label col-sm-3" for="email">New Price :</label>
    <div class="col-sm-9">
