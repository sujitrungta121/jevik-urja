   ...
   public function get_orders($args=array()) {
	...
	public function update_comment($data){
 	...
 	public function products($id){
 			$this->db->select("p.image,od.product_id,pd.name as product_name,pov.price,pov.old_price,od.unit_price as price,od.count,od.options as variant_id,ov.value_name as variant_name,od.oid");
