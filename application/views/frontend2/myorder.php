			...
			<div class="col-12">
				<div class="inner-card p-4">
					<div class="myorder" ng-repeat="ord in myOrderList">
						<div class="title2">
							<h5>Order ID: {{ord.order_id}} Order Date: {{ord.order_date}} <div class="float-right"><a href="<?php echo base_url("track-order/");?>{{ord.order_id}}" class="badge bg-warning">Track Order</a> <a href="#" class="badge bg-danger"  ng-click="cancelOrder(ord.order_id)">Cancel Order</a></div></h5>
						</div>
