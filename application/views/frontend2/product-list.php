				...
				<div class="col-xl-3">
					...
					<div class="fillter">
						...
						<div class="position-relative form-group">
							...
							<?php if(sizeof($filter_category_data)==0){?>
							...
							<div class="custom-checkbox custom-control">
								...
								<input type="checkbox" ng-click="filterProductList();" name="category_id[]" type="checkbox" checked="checked" value="<?php echo $row["category_id"];?>"> <?php echo $row["name"];?>
							</div>
							<?php } ?>
