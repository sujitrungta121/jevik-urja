...
<div id="page-wrapper">
		...
		<!-- <form action="<?php echo $this->config->item('admin_url'); ?>category/update/<?php echo $id; ?>" method="post" accept-charset="utf-8" class="form-horizontal" role="form"> -->
    <?php echo form_open_multipart("admin/category/update/".$id,array("class"=>"form-horizontal","role"=>"form"));?>				
...
<?php if($language->default == 1){ ?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input name="category_description[<?php echo $language->id; ?>][description]" value="<?php echo $category_description[$language->id]['description']; ?>" type="text" class="form-control" id="inputEmail3" >
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input name="category_description[<?php echo $language->id; ?>][meta_description]" value="<?php echo $category_description[$language->id]['meta_description']; ?>" type="text" class="form-control" id="inputEmail3" >
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Meta Keyword </label>
    <div class="col-sm-10">
      <input name="category_description[<?php echo $language->id; ?>][meta_keyword]" value="<?php echo $category_description[$language->id]['meta_keyword']; ?>" type="text" class="form-control" id="inputEmail3" >
    </div>
  </div>
...
<?php } ?>
 ...
 <hr>
  ...
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Small Image</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Main Image</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Banner Image (width : 1920px height : 800px)</label>
    <div class="col-sm-10">
