...
<div id="page-wrapper">
		...
		<form action="<?php echo $this->config->item('admin_url'); ?>category/add" method="post" accept-charset="utf-8" class="form-horizontal" role="form"  enctype="multipart/form-data"  >
