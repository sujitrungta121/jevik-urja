...
<div id="page-wrapper">
 ...
 <?php $i = 1; foreach($list AS $list) { ?>
     ...
     <?php if($type==9){?>
    <td><?php echo $list["user_state_name"];?></td>
     ...
     <td>
      ...
      <td>
        ...
        <button type="button" class="btn btn-primary" onclick="change_password('<?php echo $list["user_id"];?>')">Change Password</button>
         <?php echo form_open("admin/User/status_update");?>
...
<div id="myModal2" class="modal fade" role="dialog">
  ...
  <input type="hidden" name="user_id" id="user_id_for_password_change">
</form>
 ...
 <script type="text/javascript">
  function change_password(user_id){
    $("#myModal2").modal('show');
    $("#user_id_for_password_change").val(user_id);
