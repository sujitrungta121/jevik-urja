...
<div id="page-wrapper">
		...
		<form action="<?php echo $this->config->item('admin_url'); ?>product/add" method="post" accept-charset="utf-8" class="form-horizontal" role="form"  enctype="multipart/form-data" >				
...
<?php } else { ?>
  ...
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Product Name *</label>
    <div class="col-sm-10">
      <input name="product_description[<?php echo $language->id; ?>][name]" type="text" class="form-control" id="inputEmail3" required >
    </div>
  </div>
...
<?php } ?>
 ...
 <hr>
  ...
  <div class="form-group" >
    ...
    <div class="col-sm-10">
      <input name="wb_price" type="number" value=""  class="form-control" id="inputEmail3" >
    </div>
  </div>

  <div class="form-group" >
    <label for="inputEmail3" class="col-sm-2 control-label">WB Old Price *</label>
    <div class="col-sm-10">
      <input name="wb_old_price" type="number" value="" class="form-control" id="inputEmail3" >
    </div>
  </div>

  <div class="form-group" >
    <label for="inputEmail3" class="col-sm-2 control-label">UP Price *</label>
    <div class="col-sm-10">
      <input name="up_price" type="number" value="" class="form-control" id="inputEmail3" >
    </div>
  </div>

   <div class="form-group" >
    <label for="inputEmail3" class="col-sm-2 control-label">UP Old Price *</label>
    <div class="col-sm-10">
      <input name="up_old_price" type="number" value="" class="form-control" id="inputEmail3" >
    </div>
  </div>
