		...
		<table width="100%" border="0" cellspacing="5" cellpadding="3">
		  ...
		  <tbody>
		  	...
		  	<tr>
			    ...
			    <td style="border-radius:5px; background:#f5f5f5; font-size:16px; text-align:left; padding:10px;">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
		    <td width="68%">
		        ...
		        <p></p>
		        <h3 style="color:#1fb5ad;"><i>!!Thank you for choosing <?= SITE_TITLE;?>, have a Nice Day!!</i></h3>
		    </td>
