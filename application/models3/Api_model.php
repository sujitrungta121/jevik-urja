...
class Api_model extends CI_Model{
    ...
    function save_registration_data($name,$email,$mobile,$password,$referral_code,$time,$fcm,$id=""){
        ...
        if($id==""){
            ...
            $this->db->insert("user",array("name"=>$name,"email"=>$email,"mobile"=>$mobile,"password"=>$password,"created_on"=>$time,"own_referral_code"=>$own_referral_code,"referral_code"=>$referral_code,"status"=>3,"user_type_id"=>9));
